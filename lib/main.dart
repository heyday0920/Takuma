...
class _RestaurantSwipeScreenState extends State<RestaurantSwipeScreen>
  ...
  // MODIFIED: Added TickerProviderStateMixin
                  ...
                  children: [
                        ...
                        onSwipe: (previousIndex, currentIndex, direction) {
                          ...
                          if (direction == CardSwiperDirection.right) {
                            ...
                            _triggerBounceAnimation(
                                _likeButtonAnimationController); // MODIFIED: Trigger animation
                            print("LIKEしたお店: ${restaurant["name"]}");
                          } else if (direction == CardSwiperDirection.left) {
                            nopedRestaurants.add(restaurant);
                            _triggerBounceAnimation(
                                _nopeButtonAnimationController); // MODIFIED: Trigger animation
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ScaleTransition(
                            // MODIFIED: Wrapped with ScaleTransition
                            ...
                            child: ElevatedButton(
                              ...
                              child:
                                  Text("NOPE", style: TextStyle(fontSize: 18)),
                            ),
                          ),
                          ScaleTransition(
                            // MODIFIED: Wrapped with ScaleTransition
